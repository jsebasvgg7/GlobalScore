  ...
  return (
    <div className="admin-stats-overview">
      <div className="admin-stat-card matches">
        ...
        <div className="stat-detail">{stats.matches.pending} pendientes</div>
      </div>
      ...
      <div className="admin-stat-card leagues">
        ...
        <div className="stat-detail">{stats.leagues.active} activas</div>
      </div>
      ...
      <div className="admin-stat-card awards">
        ...
        <div className="stat-detail">{stats.awards.active} activos</div>
      </div>
      ...
      <div className="admin-stat-card system">
        ...
        <div className="stat-value">{stats.achievements.total + stats.titles.total}</div>
        <div className="stat-detail">logros y títulos</div>
      </div>
    </div>
  );
}