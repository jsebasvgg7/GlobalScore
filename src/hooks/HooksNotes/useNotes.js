// src/hooks/HooksNotes/useNotes.js
// ================================================================
//  GlobalScore — useNotes
//  Cifrado AES-256-CBC del lado del cliente usando Web Crypto API.
//  El contenido NUNCA viaja ni se guarda en texto plano.
//
//  Clave de cifrado: derivada del auth_id del usuario con PBKDF2.
//  Sin la clave (sin sesión activa), el texto es ilegible.
// ================================================================
...
const SALT      = 'GlobalScore_Notes_v1';   // sal estática (no secreta)
